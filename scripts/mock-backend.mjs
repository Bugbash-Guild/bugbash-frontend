...
const routes = {
  ...
  "/api/shop/items": {
    items: [
      { itemId: "soul-pack-s", name: "魂パック・小", description: "魂 5", currency: "GUILD_COIN", price: 500, iconUrl: null },
      { itemId: "soul-pack-m", name: "魂パック・中", description: "魂 15", currency: "GUILD_COIN", price: 1500, iconUrl: null },
      { itemId: "soul-pack-l", name: "魂パック・大", description: "魂 30", currency: "GUILD_COIN", price: 3000, iconUrl: null },
      { itemId: "evolution-stone", name: "進化の輝石", description: "Lv50で進化", currency: "GUILD_COIN", price: 2000, iconUrl: null },
      { itemId: "purification-proof", name: "浄化の証", description: "路線変更", currency: "GUILD_COIN", price: 5000, iconUrl: null },
      { itemId: "abyss-proof", name: "深淵の証", description: "路線変更", currency: "GUILD_COIN", price: 20000, iconUrl: null },
      { itemId: "rune-soul-fire-s", name: "火の魂パック・小", description: "火の魂 50", currency: "RUNE", price: 30, iconUrl: null },
      { itemId: "rune-soul-fire-m", name: "火の魂パック・中", description: "火の魂 150", currency: "RUNE", price: 80, iconUrl: null },
      { itemId: "rune-soul-fire-l", name: "火の魂パック・大", description: "火の魂 450", currency: "RUNE", price: 210, iconUrl: null },
    ],
  },
  "/api/skins": { skins: [] },
